...
- [ ] Caso de éxito de McMarketing (flujo n8n)
- [ ] Formulario de contacto / WhatsApp
- [ ] SEO básico (metadata, og:image, sitemap)

## Fase 3 — Crecimiento
- [ ] Blog / novedades
- [ ] Demo interactiva de agentes
- [ ] Analytics (Vercel Analytics)
- [ ] Más agentes al roster

## Mejora continua
Cada sesión de trabajo: actualizar CHANGELOG.md, marcar avances aquí, y proponer 1–2 mejoras.
